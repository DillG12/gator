...
func (q *Queries) GetNextFeedToFetch(ctx context.Context, lastFetchedAt sql.NullTime) (GetNextFeedToFetchRow, error) {
...
func (q *Queries) MarkFeedAsFetched(ctx context.Context, arg MarkFeedAsFetchedParams) error {
	_, err := q.db.ExecContext(ctx, markFeedAsFetched, arg.ID, arg.LastFetchedAt, arg.UpdatedAt)
	return err
}
